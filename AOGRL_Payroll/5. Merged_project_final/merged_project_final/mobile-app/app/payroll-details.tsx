      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.summaryCards}>
          <View style={styles.summaryCard}>
            ...
            <Text style={styles.summaryValue}>Rs {period.totalGross.toLocaleString()}</Text>
          </View>
          <View style={styles.summaryCard}>
            <Text style={styles.summaryLabel}>Total Deductions</Text>
            <Text style={[styles.summaryValue, { color: '#ef4444' }]}>
              -Rs {period.totalDeductions.toLocaleString()}
            </Text>
          </View>
          <View style={styles.summaryCard}>
            <Text style={styles.summaryLabel}>Total Net</Text>
            <Text style={[styles.summaryValue, { color: '#10b981' }]}>
              Rs {period.totalNet.toLocaleString()}
            </Text>
          </View>
        </View>
    ...
    <View style={styles.employeeCard}>
      ...
      <View style={styles.payDetails}>
        ...
        <View style={[styles.payRow, styles.payRowBorder]}>
          ...
          <Text style={styles.payValue}>Rs {entry.grossPay.toLocaleString()}</Text>
        </View>
        ...
        {entry.deductions.map((deduction: any, index: number) => (
          <View key={index} style={styles.payRow}>
            ...
            <Text style={styles.deductionValue}>-Rs {deduction.amount.toFixed(2)}</Text>
          </View>
        ))}
        
        <View style={[styles.payRow, styles.payRowBorder]}>
          <Text style={styles.netLabel}>Net Pay</Text>
          <Text style={styles.netValue}>Rs {entry.netPay.toLocaleString()}</Text>
        </View>
      </View>
    </View>
  );
