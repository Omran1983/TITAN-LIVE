...
export default function SimpleDemo() {
  ...
  useEffect(() => {
    // Simulate fetching real data (would come from our API in a real implementation)
    const fetchDashboardData = async () => {
      try {
        setLoading(true)
        // This simulates what our real API returns - structured data with 0s instead of fake numbers
        const result = {
          revenue: 0,
          campaigns: 0,
          impressions: 0,
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-6 mb-12">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Why You're Seeing Zeros</h2>
          <div className="space-y-4 text-gray-700">
            <p>
              The zeros you see above represent the successful implementation of our radical solution. 
              Instead of fake data like "$1,234,567 revenue" or "24 campaigns", we show real data with 
              proper defaults (0s) until connected to actual data sources.
            </p>
            <p>
              This approach provides several key benefits:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>No confusion between fake and real data</li>
              <li>Clean, professional interface ready for production</li>
              <li>Easy integration with real business data sources</li>
              <li>Maintainable code without mock implementations</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl shadow-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button 
              ...
              className="px-6 py-3 bg-white text-indigo-600 font-medium rounded-lg hover:bg-gray-50 transition-colors"
            >
              View Full Dashboard
            </button>
            <button 
              onClick={() => window.location.href = '/radical-demo'}
              className="px-6 py-3 bg-indigo-800 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors"
            >
              View Detailed Demo
            </button>
          </div>
