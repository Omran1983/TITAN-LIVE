...
Write-Host "=== Jarvis-InstallBusinessAgent ==="

$taskName   = "Jarvis-BusinessAgent"
$scriptPath = "F:\AION-ZERO\scripts\Jarvis-BusinessAgent.ps1"

if (-not (Test-Path $scriptPath)) {
    throw "Business agent script not found at $scriptPath"
}
